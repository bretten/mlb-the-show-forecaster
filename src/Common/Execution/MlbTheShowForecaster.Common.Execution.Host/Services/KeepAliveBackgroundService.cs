...
public sealed class KeepAliveBackgroundService<T> : NestedBackgroundService<T> where T : IDisposable
{
    /// <summary>
    /// Constructor
    /// </summary>
    /// <param name="service"><inheritdoc /></param>
    public KeepAliveBackgroundService(T service) : base(service)
    {
    }
