...
public static class HostCreator
{
    ...
    /// </summary>
    private static readonly Func<IPlayerStatusTracker, Task> PlayerTrackerBackgroundWork =
        async (tracker) => { await tracker.TrackPlayers(SeasonYear.Create(2024)); };
