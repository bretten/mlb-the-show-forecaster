...
/// <summary>
/// Represents a decline in an entity's pitching stats
/// </summary>
...
public sealed record PitchingStatsDeclineEvent(SeasonYear Year, MlbId MlbId, PercentageChange Comparison, DateOnly Date)
