...
{
    /// <inheritdoc />
    public PlayerDeactivationEventConsumer(ICommandSender commandSender, ITrendReporter trendReporter,
    ...
    {
        return new PlayerDeactivationForecastImpact(ev.Date, ev.Date.AddDays(Duration.PlayerDeactivation));
    }
}