locals {
  ...
  url_player_tracker      = "${var.scheme_private_access}://${local.dns_name_player_tracker}:${var.port_player_tracker}"
  ...
  url_performance_tracker      = "${var.scheme_private_access}://${local.dns_name_performance_tracker}:${var.port_performance_tracker}"
  ...
  url_marketplace_watcher      = "${var.scheme_private_access}://${local.dns_name_marketplace_watcher}:${var.port_marketplace_watcher}"
