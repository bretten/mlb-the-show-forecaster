...
public class StatJsonConverterTests
{
    ...
    public void Read_BattingStatsJson_ParsesToBattingStatsDto()
    {
        ...
        var actualGame1 = actual.Splits.ElementAt(0) as GameStatSplitHittingDto;
        ...
        var actualGame2 = actual.Splits.ElementAt(1) as GameStatSplitHittingDto;
    ...
    public void Write_BattingStatsDto_ThrowsException()
    {
        ...
        // Assert
        Assert.NotNull(actual);
        Assert.IsType<JsonConverterWriteNotImplementedException>(actual);
    }
