...
public class GetAllPlayerCardsQueryHandlerTests
{
    ...
    public async Task Handle_QueryWithYear_ReturnsPlayerCardsForYear()
    {
        ...
        var playerCard1 = Faker.FakePlayerCard(year: 2024, externalId: "1");
        var playerCard2 = Faker.FakePlayerCard(year: 2023, externalId: "2"); // Year is different, 2023
        var playerCard3 = Faker.FakePlayerCard(year: 2024, externalId: "3");
