...
public class CardPriceTrackerTests
{
    ...
    public async Task TrackCardPrices_SeasonYear_CreatesAndUpdatesListingPrices()
    {
        ...
        var domainPlayerCard1 = TestClasses.Faker.FakePlayerCard(year: year.Value, externalId: cardExternalId1.Value);
        ...
        var domainPlayerCard2 = TestClasses.Faker.FakePlayerCard(year: year.Value, externalId: cardExternalId2.Value);
        ...
        var externalListing3 = Faker.FakeCardListing(cardExternalId: cardExternalId3.Value);
        var domainListing3 = TestClasses.Faker.FakeListing(cardExternalId: cardExternalId3.Value, 3, 30);
        var domainPlayerCard3 = TestClasses.Faker.FakePlayerCard(year: year.Value, externalId: cardExternalId3.Value);
