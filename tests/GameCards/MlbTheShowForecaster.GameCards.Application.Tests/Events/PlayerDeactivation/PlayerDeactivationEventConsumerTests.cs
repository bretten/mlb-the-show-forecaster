...
public class PlayerDeactivationEventConsumerTests : BaseForecastImpactEventConsumerTests
{
    ...
    public async Task Handle_PlayerDeactivationEvent_AppliesForecastImpact()
    {
        ...
        var consumer = new PlayerDeactivationEventConsumer(mockCommandSender.Object, stubCalendar.Object,
        ...
        // Assert
        var expectedImpact =
            new PlayerDeactivationForecastImpact(stubCalendar.Object.Today()
                .AddDays(stubImpactDuration.PlayerDeactivation));
