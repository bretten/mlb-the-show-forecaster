...
public class PlayerActivationEventConsumerTests : BaseForecastImpactEventConsumerTests
{
    ...
    public async Task Handle_PlayerActivationEvent_AppliesForecastImpact()
    {
        ...
        var consumer = new PlayerActivationEventConsumer(mockCommandSender.Object, stubCalendar.Object,
        ...
        // Assert
        var expectedImpact =
            new PlayerActivationForecastImpact(stubCalendar.Object.Today()
                .AddDays(stubImpactDuration.PlayerActivation));
