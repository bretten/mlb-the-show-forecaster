...
public class DependenciesTests
{
    ...
    public void AddPerformanceAssessment_ServiceCollection_RegistersDependencies()
    {
        ...
        var settings = new Dictionary<string, string?>
        {
            ...
            // Batting criteria[0]
            { Dependencies.ConfigKeys.MinMaxNormBattingCriteriaSection + ":0:Name", "Hits" },
            { Dependencies.ConfigKeys.MinMaxNormBattingCriteriaSection + ":0:Weight", "0.9" },
            { Dependencies.ConfigKeys.MinMaxNormBattingCriteriaSection + ":0:IsLowerValueBetter", "false" },
            { Dependencies.ConfigKeys.MinMaxNormBattingCriteriaSection + ":0:Min", "10" },
            { Dependencies.ConfigKeys.MinMaxNormBattingCriteriaSection + ":0:Max", "100" },
            // Batting criteria[1]
            { Dependencies.ConfigKeys.MinMaxNormBattingCriteriaSection + ":1:Name", "Strikeouts" },
            { Dependencies.ConfigKeys.MinMaxNormBattingCriteriaSection + ":1:Weight", "0.1" },
            { Dependencies.ConfigKeys.MinMaxNormBattingCriteriaSection + ":1:IsLowerValueBetter", "true" },
            { Dependencies.ConfigKeys.MinMaxNormBattingCriteriaSection + ":1:Min", "5" },
            { Dependencies.ConfigKeys.MinMaxNormBattingCriteriaSection + ":1:Max", "50" },

            // Pitching criteria[0]
            { Dependencies.ConfigKeys.MinMaxNormPitchingCriteriaSection + ":0:Name", "Wins" },
            { Dependencies.ConfigKeys.MinMaxNormPitchingCriteriaSection + ":0:Weight", "0.6" },
            { Dependencies.ConfigKeys.MinMaxNormPitchingCriteriaSection + ":0:IsLowerValueBetter", "false" },
            { Dependencies.ConfigKeys.MinMaxNormPitchingCriteriaSection + ":0:Min", "2" },
            { Dependencies.ConfigKeys.MinMaxNormPitchingCriteriaSection + ":0:Max", "20" },
            // Pitching criteria[1]
            { Dependencies.ConfigKeys.MinMaxNormPitchingCriteriaSection + ":1:Name", "Losses" },
            { Dependencies.ConfigKeys.MinMaxNormPitchingCriteriaSection + ":1:Weight", "0.4" },
            { Dependencies.ConfigKeys.MinMaxNormPitchingCriteriaSection + ":1:IsLowerValueBetter", "true" },
            { Dependencies.ConfigKeys.MinMaxNormPitchingCriteriaSection + ":1:Min", "3" },
            { Dependencies.ConfigKeys.MinMaxNormPitchingCriteriaSection + ":1:Max", "30" },

            // Fielding criteria[0]
            { Dependencies.ConfigKeys.MinMaxNormFieldingCriteriaSection + ":0:Name", "Errors" },
            { Dependencies.ConfigKeys.MinMaxNormFieldingCriteriaSection + ":0:Weight", "0.2" },
            { Dependencies.ConfigKeys.MinMaxNormFieldingCriteriaSection + ":0:IsLowerValueBetter", "true" },
            { Dependencies.ConfigKeys.MinMaxNormFieldingCriteriaSection + ":0:Min", "1" },
            { Dependencies.ConfigKeys.MinMaxNormFieldingCriteriaSection + ":0:Max", "10" },
            // Fielding criteria[1]
            { Dependencies.ConfigKeys.MinMaxNormFieldingCriteriaSection + ":1:Name", "Putouts" },
            { Dependencies.ConfigKeys.MinMaxNormFieldingCriteriaSection + ":1:Weight", "0.8" },
            { Dependencies.ConfigKeys.MinMaxNormFieldingCriteriaSection + ":1:IsLowerValueBetter", "false" },
            { Dependencies.ConfigKeys.MinMaxNormFieldingCriteriaSection + ":1:Min", "8" },
            { Dependencies.ConfigKeys.MinMaxNormFieldingCriteriaSection + ":1:Max", "80" },
        };
